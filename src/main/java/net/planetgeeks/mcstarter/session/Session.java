 ...
 * manage them.
 * <ul>
 * <li> {@link #Session.getId()} return the id (email/username) linked to this
 * session. It will be used during authentication or similiar requests.</li>
 * <li> {@link #Session.getAccessToken()} return the accessToken generated by
 * Yggdrasil or resumed from a saved session.</li>
 * <li> {@link #Session.getClientToken()} return the clientToken.</li>
 * <li> {@link #Session.getAvailableProfiles()} return the list of profiles
 * linked to this session.</li>
 * <li> {@link #Session.getSelectedProfile()} return the selected profile linked
 * to this session.</li>
 * <li> {@link #Session.isValid()} return true if an accessToken has been setted
 * in this session. to be retrieved.</li>
 * </ul>
 * 
 * Usage example:
 * 
...
public class Session
{
	...
	/**
	 * @return true if there is an accessToken
	 */
	 ...
	 * @return this object.
	 */
	public Session setPassword(@NonNull String password)
	{
